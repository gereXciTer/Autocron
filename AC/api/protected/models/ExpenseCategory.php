 ...
 *
 * The followings are the available columns in table 'expense_category':
 * @property double $id
 * @property double $uid
 ...
 */
class ExpenseCategory extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ExpenseCategory the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, uid, name, name_ru, primary', 'safe', 'on'=>'search'),
		);
	}
